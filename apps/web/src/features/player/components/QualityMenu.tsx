...
const QUALITIES: Array<{ value: QualityPreference; label: string; detail: string }> = [
  { value: 'auto', label: t.player.quality.auto, detail: t.player.quality.autoDetail },
  { value: 'original', label: t.player.quality.original, detail: t.player.quality.originalDetail },
      ...
      >
        <span>
          ...
          <span className="text-[10px] text-zinc-500">
            {quality.value === 'auto' ? t.player.quality.current(effectiveQuality) : quality.detail}
          </span>
        </span>
