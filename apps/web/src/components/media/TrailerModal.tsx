  ...
  return createPortal(
    ...
    >
      <div
        ...
        className="relative w-full max-w-4xl bg-zinc-950 border border-zinc-800 rounded-3xl overflow-hidden shadow-2xl flex flex-col max-h-[90vh] my-auto animate-scale-up"
      >
        {/* Modal Header */}
