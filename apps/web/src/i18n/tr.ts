...
export const tr = {
  ...
  music: {
    ...
    mixesPageTitle: 'Her ana uygun bir istasyon',
    mixesPageDescription:
      'Kütüphanenin tamamından, farklı sanatçı ve albümleri dengeli biçimde bir araya getiren kişisel mixler ve radyolar.',
    personalRadio: 'Kişisel müzik akışın',
    startListening: 'Dinlemeye başla',
    radio: 'Radyo istasyonları',
    artistRadios: 'Sanatçı Radyoları',
    artistRadiosDescription:
      'Sevdiğin bir sanatçıyla başla; benzer tür, dönem ve farklı sanatçılarla akış devam etsin.',
    playArtistRadio: (name: string) => `${name} radyosunu oynat`,
    diverseArtistRadio: 'Karışık sanatçı radyosu',
    radioLoadFailed: 'Radyo istasyonu hazırlanamadı.',
    moodStations: 'Ruh Haline Göre',
    moodStationsDescription:
      'Odaklanmak, dinlenmek veya enerjini yükseltmek için dengeli seçkiler.',
    genreStations: 'Tür İstasyonları',
    genreStationsDescription:
      'Albüm ve parça etiketlerinden, tek bir sanatçıya yüklenmeyen geniş tür seçkileri.',
    timeTravel: 'Zamanda yolculuk',
    decades: 'Dönemlere Göre',
    decadesDescription: 'Farklı dönemlerin sanatçı, albüm ve ses dünyalarını yeniden keşfet.',
    continuousPlay: 'Aralıksız Çalma',
    continuousPlayHint: 'Kuyruk bittiğinde çalan parçaya uygun yeni bir radyo otomatik hazırlanır.',
    ...
    addToAnotherPlaylist: 'Başka Çalma Listesine Ekle',
    addTracks: 'Parça Ekle',
    addSelectedTracks: (count: number) => `Ekle (${count})`,
    addTrackCount: (count: number) => `${count} parça eklenecek`,
    choosePlaylist: 'Çalma listesi seç',
    createAndAdd: 'Oluştur ve Ekle',
    tracksAddedToPlaylist: (count: number, name: string) =>
      `${count} parça “${name}” listesine eklendi.`,
    searchLibraryTracks: 'Kütüphanende ara…',
    noMorePlaylistTracks: 'Tüm parçalar zaten bu listede.',
    noMatchingPlaylistTracks: 'Eşleşen parça bulunamadı.',
    duplicatePlaylist: 'Çalma Listesini Çoğalt',
    playlistCopyName: (name: string) => `${name} Kopyası`,
    playlistDuplicated: 'Çalma listesi çoğaltıldı.',
    saveQueueAsPlaylist: 'Kuyruğu Çalma Listesi Olarak Kaydet',
    saveQueueHint: 'Kuyruktaki tüm parçalar sıraları korunarak yeni listeye eklenecek.',
    defaultQueuePlaylistName: 'Kaydedilen Kuyruk',
    queueSavedAsPlaylist: 'Kuyruk çalma listelerine kaydedildi.',
    ...
    popularTracks: 'Popüler Şarkılar',
    localPopularTracksHint: 'CineDrive’daki dinleme sayılarına göre sıralanır.',
    artistListeningTotal: (count: number) => `Toplam ${count} dinleme`,
    artistCollection: 'Sanatçı Koleksiyonu',
    artistEssentials: 'Eksiksiz sanatçı seçkisi',
    thisIsArtist: (name: string) => `This Is ${name}`,
    artistEssentialsDescription: (name: string, count: number) =>
      `${name} arşivindeki ${count} parçanın tamamına tek bir listeden ulaşın.`,
    openArtistTrackList: 'Tüm parçaları göster',
    ...
    mixSavedToast: (name: string) => `${name} çalma listelerine kaydedildi`,
    ...
    rediscoveryMix: 'Yeniden Keşfet',
    favoritesMix: 'Favori Akışı',
    ...
    moodsAndGenresDescription:
      'Parça ve albüm türlerinden üretilen ruh hali, tür ve dönem seçkileri. Beğendiğinizi kalıcı çalma listesine dönüştürebilirsiniz.',
    ...
    maintenanceArtwork: 'Görseller',
    maintenanceMetadata: 'Metadata',
    maintenanceAudio: 'Ses & Kopyalar',
    maintenanceActivity: 'İnceleme ve Geçmiş',
    maintenanceSections: 'Kütüphane bakımı bölümleri',
    maintenanceIssueCount: (count: number) => `${count} bakım öğesi`,
    artistArtworkCoverage: (ready: number, total: number) => `${ready}/${total} sanatçı görselli`,
    pendingSuggestionCount: (count: number) => `${count} inceleme bekliyor`,
    smartScan: 'Akıllı Taramayı Başlat',
    smartScanComplete: 'Akıllı tarama tamamlandı',
    smartScanResult: (count: number) => `${count} yeni öneri oluşturuldu.`,
    recommendedNextStep: 'Önerilen sonraki adım',
    reviewPendingChanges: 'Bekleyen önerileri incele',
    reviewPendingChangesHint: (count: number) =>
      `${count} değişiklik uygulanmadan önce kararınızı bekliyor.`,
    openReviewQueue: 'İnceleme kuyruğunu aç',
    reviewMetadataIssues: 'Metadata sorunlarını incele',
    reviewMetadataIssuesHint: (count: number) =>
      `${count} parçada eksik veya düşük güvenli bilgi bulundu.`,
    openMetadataWorkspace: 'Metadata alanını aç',
    reviewAudioIssues: 'Ses analizini tamamla',
    reviewAudioIssuesHint: (count: number) =>
      `${count} parça ses analizi veya kopya kontrolü bekliyor.`,
    openAudioWorkspace: 'Ses araçlarını aç',
    libraryHealthy: 'Kütüphane düzenli',
    libraryHealthyHint: 'Şu anda müdahale gerektiren bir bakım öğesi görünmüyor.',
    upToDate: 'Güncel',
    ...
    pendingReview: 'İnceleme Kuyruğu',
    pendingReviewHint: 'Karar vermenizi bekleyen değişiklikler.',
    noSuggestionsHint: 'Yeni bir tarama başlatabilir veya diğer bakım alanlarına geçebilirsiniz.',
    suggestionAccepted: 'Öneri uygulandı',
    suggestionRejected: 'Öneri reddedildi',
    artistArtworkStudio: 'Sanatçı Görsel Stüdyosu',
    artistArtworkStudioHint:
      'Çevrimiçi eşleşmeleri tarayın, sonuçları izleyin veya kendi görselinizi yükleyin.',
    artworkCoverage: 'Görsel kapsamı',
    allArtistArtworkReady: 'Tüm sanatçı görselleri hazır',
    scanNextArtists: 'Sıradaki 12 Sanatçıyı Tara',
    scannedCount: (count: number) => `${count} tarandı`,
    foundCount: (count: number) => `${count} bulundu`,
    notFoundCount: (count: number) => `${count} kaynak yok`,
    failedCount: (count: number) => `${count} hata`,
    artistArtworkScanResult: (found: number, scanned: number) =>
      `${scanned} sanatçı tarandı, ${found} görsel eklendi`,
    artistArtworkScanEmpty: (scanned: number) =>
      `${scanned} sanatçı tarandı; yeni görsel bulunamadı`,
    artistArtworkScanDetail: (notFound: number, failed: number) =>
      `${notFound} kaynak bulunamadı${failed ? ` · ${failed} hata` : ''}`,
    artistArtworkScanFailed: 'Sanatçı görseli taraması tamamlanamadı',
    previouslyFoundArtwork: 'Önceden Bulunan Görseller',
    previouslyFoundArtworkHint: 'Eski taramalardan kalan sonuçları inceleyin.',
    artistLibrary: 'Sanatçı Kütüphanesi',
    artistLibraryHint: 'Her sanatçının görsel durumunu ve kaynağını tek yerde yönetin.',
    searchArtists: 'Sanatçı ara',
    editArtistName: (name: string) => `${name} sanatçı adını düzenle`,
    missingOnly: 'Eksikler',
    allArtists: 'Tümü',
    noIdentity: 'Çevrimiçi kimlik yok',
    noArtistsInFilter: 'Bu filtrede sanatçı yok',
    noArtistsInFilterHint: 'Arama ifadesini veya görsel filtresini değiştirin.',
    artistLookupStatuses: {
      pending: 'Taranmayı bekliyor',
      found: 'Görsel hazır',
      'not-found': 'Kaynak bulunamadı',
      failed: 'Tarama hatası',
      'manual-skip': 'Elle kaldırıldı',
    },
    artistArtworkUploaded: 'Sanatçı görseli yüklendi',
    artistArtworkRemoved: 'Sanatçı görseli kaldırıldı',
    artistUpdated: 'Sanatçı güncellendi',
    metadataWorkspace: 'Metadata Çalışma Alanı',
    bulkMetadataUpdated: (count: number) => `${count} parça güncellendi`,
    albumUpdated: 'Albüm güncellendi',
    duplicateArchived: 'Düşük kaliteli kopya arşivlendi',
    noDuplicates: 'Yinelenen parça bulunamadı',
    noDuplicatesHint: 'Başlık ve ses parmak izi kontrolleri temiz görünüyor.',
    actionHistoryHint: 'Uygulanan değişiklikleri inceleyin ve gerektiğinde geri alın.',
    actionUndone: 'İşlem geri alındı',
    actionReverted: 'Geri alındı',
    noMaintenanceActions: 'Henüz işlem yok',
    noMaintenanceActionsHint: 'Uygulanan bakım değişiklikleri burada görünür.',
    maintenanceActions: {
      'accept-artwork': 'Albüm kapağı uygulandı',
      'accept-artist-artwork': 'Sanatçı görseli uygulandı',
      'auto-artist-artwork': 'Sanatçı görseli otomatik uygulandı',
      'set-artist-artwork': 'Sanatçı görseli değiştirildi',
      'edit-artist': 'Sanatçı düzenlendi',
      'accept-metadata': 'Metadata uygulandı',
      'accept-acoustic-metadata': 'Akustik metadata uygulandı',
      'archive-duplicate': 'Yinelenen dosya arşivlendi',
    },
    ...
    suggestionKinds: {
      metadata: 'Parça bilgisi önerisi',
      'acoustic-metadata': 'Ses eşleşmesi önerisi',
      artwork: 'Görsel önerisi',
    },
    suggestionFields: {
      title: 'Parça adı',
      artist: 'Sanatçı',
      ...
      recordingMatch: 'Parça eşleşmesi',
      albumMatch: 'Albüm eşleşmesi',
      artwork: 'Görsel',
    },
    suggestionConfidence: (confidence: number) => `%${confidence} güven`,
    suggestionEmpty: 'Yok',
    suggestionMore: (count: number) => `ve ${count} kişi daha`,
    suggestionMatchFound: 'Bulundu',
    suggestionMatchMissing: 'Eşleşme yok',
    suggestionArtworkMissing: 'Mevcut görsel yok',
    suggestionArtworkReady: 'Yeni görsel hazır',
    suggestionUnknownTarget: 'Öğe adı bulunamadı',
    suggestionNoVisibleChanges: 'Yalnız teknik doğrulama bilgileri güncellenecek.',
    ...
    archiveDuplicateConfirm: (name: string) =>
      `${name} arşivlenecek ve çalma listelerinde önerilen kopyayla değiştirilecek. Devam edilsin mi?`,
    ...
    missingArtistArtwork: 'Eksik sanatçı görseli',
    ...
    selectListedTracks: 'Bu sayfayı seç',
    clearTrackSelection: 'Seçimi temizle',
    metadataPage: (page: number, total: number) => `Sayfa ${page}/${total}`,
    previousMetadataPage: 'Önceki metadata sayfası',
    nextMetadataPage: 'Sonraki metadata sayfası',
    leaveUnchanged: 'Değiştirmek için doldurun',
    albumArtistField: 'Albüm sanatçısı',
    bulkSaveHint:
      'Önce parçaları seçin, sonra yalnız değiştirmek istediğiniz alanları doldurup kaydedin.',
    ...
    replayHourShort: 'sa',
    replayMinuteShort: 'dk',
    replayTopArtist: 'Bu dönemin sanatçısı',
    replayTopTrack: 'En çok dinlediğin parça',
    replayPeak: 'Zirve',
    replayActivityHint: 'Günün hangi saatlerinde daha çok müzik dinlediğin',
    replayWeekHint: 'Haftalık dinleme ritmin',
    replayNoData: 'Bu dönem için dinleme kaydı yok',
    replayNoDataHint:
      'Müzik dinledikçe sanatçılar, parçalar ve dinleme alışkanlıkların burada görünür.',
    ...
    topTracks: 'En Çok Dinlenen Parçalar',
    ...
    dailyDiscoveryHint: 'Az çalınanlar, tercihler ve kütüphane çeşitliliğiyle her gün yenilenir',
  ...
  settings: {
    ...
    users: {
      ...
      libraryAccess: 'Kütüphane erişimi',
      selectLibrary: 'Kütüphane seçin',
      selectUser: 'Kullanıcı seçin',
      listener: 'Dinleyici',
      editor: 'Düzenleyici',
      owner: 'Sahip',
      addAccess: 'Erişim ver',
      removeAccess: 'Erişimi kaldır',
      noMembers: 'Bu kütüphaneye henüz başka kullanıcı eklenmedi.',
      saved: 'Kullanıcı erişimi güncellendi.',
  ...
  systemMetrics: {
    ...
    subtitle: 'CineDrive sunucusunun işlemci, bellek, disk ve ağ durumu.',
    loading: 'Sistem metrikleri yükleniyor…',
    loadFailed: 'Sistem metrikleri yüklenemedi.',
    refresh: 'Yenile',
    cpu: 'CPU kullanımı',
    memory: 'Bellek kullanımı',
    disk: 'Disk kullanımı',
    temperature: 'Sıcaklık',
    temperatureHint: 'Donanım sensörü sunuluyorsa en yüksek değer',
    unavailable: 'Desteklenmiyor',
    collecting: 'Ölçülüyor…',
    utilization: 'Kullanım',
    ofTotal: (total: string) => `${total} toplam kapasite`,
    diskRead: 'Disk okuma',
    diskWrite: 'Disk yazma',
    download: 'Ağ indirme',
    upload: 'Ağ yükleme',
    scope: {
      container: 'Container sınırları içindeki kullanım',
      host: 'Sunucu genelindeki kullanım',
    },
    sampledAt: (date: string) => `Son örnek: ${date}`,
    bandwidthTitle: '7 Günlük Ağ Trafiği',
    bandwidthSubtitle: 'Varsayılan ağ arayüzündeki günlük indirme ve yükleme toplamları.',
    bandwidthChartLabel: 'Son yedi günün ağ trafiği grafiği',
    received: 'İndirilen',
    transmitted: 'Yüklenen',
    retentionHint: (seconds: number, days: number) =>
      `${seconds} saniyede bir örneklenir; ${days} günden eski ölçümler otomatik silinir.`,
  },
