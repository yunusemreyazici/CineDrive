...
export const tr = {
  ...
  music: {
    ...
    acousticFingerprintHint: 'Chromaprint ses içeriğini analiz eder; aynı kaydın farklı dosya ve codec kopyalarını etiketten bağımsız bulur.',
    ...
    acoustidNotConfigured: 'AcoustID anahtarı yok; gerçek yinelenenler bulunur ancak çevrimiçi parça kimliği aranmaz.',
    fingerprintsAnalyzed: (analyzed: number, identified: number) => `${analyzed} analiz · ${identified} AcoustID eşleşmesi`,
